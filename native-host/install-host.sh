...
TEMPLATE="$SCRIPT_DIR/com.hyperfetch.host.template.json"
...
if [[ "${XDG_CONFIG_HOME:-}" != "" ]]; then
  CHROME_HOST_DIR="$XDG_CONFIG_HOME/google-chrome/NativeMessagingHosts"
else
...
HOST_MANIFEST="$CHROME_HOST_DIR/com.hyperfetch.host.json"
...
echo "Installed native host manifest: $HOST_MANIFEST"
